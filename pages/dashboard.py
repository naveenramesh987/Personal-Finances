        ...
        self.content = Row(
            ...
            controls=[
                Container(
                    ...
                    content=Column(
                        controls=[
                            Row(controls=[Icon(icons.PERSON, size=50)]),
                            Divider(color="#9caede", height=0.5, thickness=0.5),
                            Container(
                                Text(value="Dashboard", size=14, color="white"),
                            ),
                            Divider(color="#9caede", height=0.5, thickness=0.5),
                            Container(
                                Text(value="Utilities", size=14, color="white"),
                            ),
                            Divider(color="#9caede", height=0.5, thickness=0.5),
                            Row(
                                alignment="center",
                    ...
                    content=Column(
                        ...
                        controls=[
                            Container(
                                height=70,
                                shadow=BoxShadow(
                                    spread_radius=2, blur_radius=20, color="#1a000000"
                                ),
                                    ...
                                    controls=[
                                        ...
                                        Row(
                                            ...
                                            controls=[
                                                ...
                                                CircleAvatar(
                                                    foreground_image_url="", radius=15
                                                ),
                                            ],
                                        ),
                                    ],
    ...
    def get_fig(self):
        ...
        fig.add_trace(
            go.Scatter(
                ...
                y=spendings,
                mode="lines+markers",
                line=dict(shape="spline", width=5, color="rgba(78, 115, 223, 0.5)"),
                fill="tozeroy",
